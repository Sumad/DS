...
#### Chi-Square
If a normal random variable is squared it forms a distribution called chi-square distribution.
If several normals random variables are squared and added, distribution of resulting variable
is chi square.
Example : See below
